...
| URL | 内容 |
|-----|------|
| `http://192.168.1.211:8081/` | 設定 GUI |
| `http://192.168.1.211:8081/overlay.html` | キー表示 + 入力履歴（両方表示） |
| `http://192.168.1.211:8081/input` | キー表示のみ（履歴なし） |
| `http://192.168.1.211:8081/history` | 入力履歴のみ（キー表示なし） |
